...
| P8  | Failure injection drill                                | **done**    |
| P9  | Trade-off + migration drills                           | todo        |
| P10 | ADR + founder proposal v2 (grounded in workspace)      | todo        |
| P11 | Interview / panel mode (timed)                         | **done** (interview timer in drill wizard) |
| P12 | Calibration: skills passport + gaps + spaced rep       | **done** (FSRS review queue + 5-axis scoring) |
| P13 | Polish: mobile, performance, error boundaries          | **done** (sidebar shell, error boundaries, responsive) |

**Current phase pointer**: P9
